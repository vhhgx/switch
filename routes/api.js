...
router.post('/api/providers/enable-all', providerController.enableAll)
router.post('/api/providers/disable-all', providerController.disableAll)
router.post('/api/providers/reorder', providerController.reorder)
